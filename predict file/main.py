...
# Muat model
model = tf.keras.models.load_model('/home/arahi/predick-api/model/model.h5')

# Set up Google Application Credentials
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "/home/arahi/predick-api/config/serviceAccount.json"
